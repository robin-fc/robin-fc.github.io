/*! For license information please see 8815.afd2827b.js.LICENSE.txt */
"use strict";(self.webpackChunkrobin_fc_github_io=self.webpackChunkrobin_fc_github_io||[]).push([[8815],{580:(t,e,s)=>{s.d(e,{T:()=>a});var i=s(4703),n=s(2993);class o extends n.D{}o.directiveName="unsafeSVG",o.resultType=2;const a=(0,i.u$)(o)},1402:(t,e,s)=>{s.d(e,{In:()=>v,UT:()=>g,kj:()=>h,xZ:()=>c});var i=s(7933),n=s(4245),o=s(1822),a=s(580),l=s(6214),r=s(4259);class d extends l.Kq{#t=null;#e=!1;#s=null;constructor(t){super(t),this.#e=t.type===l.OA.ATTRIBUTE||t.type===l.OA.BOOLEAN_ATTRIBUTE}render(t){return t!==this.#t&&(this.disconnected(),this.#t=t,this.isConnected&&this.#i()),this.#t?this.#n((0,i.se)(this.#t)):n.s6}reconnected(){this.#i()}disconnected(){this.#s?.(),this.#s=null}#i(){this.#t&&(this.#s=(0,i.QZ)(this.#o.bind(this)))}#n(t){return this.#e?(0,o.J)(t):t}#a(t){this.setValue(this.#n(t))}#o(){this.#a(this.#t?.())}}function c(t){return(0,l.u$)(d)((0,i.EW)(t))}class u{#l;#r;elements=new Set;constructor(t,e){this.#l=t,this.#r=e}connect(){this.#d();const t=new MutationObserver(this.#c);for(const e of this.#l)t.observe(e,{childList:!0,subtree:!0});(0,i.zp)((()=>t.disconnect())),(0,i.zp)(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,e){(0,i.vA)(t)?(e.textContent="",e.append(t)):((0,n.XX)(null,e),(0,n.XX)(t,e)),e.style.display||(e.style.display="contents");const s=e.firstElementChild;if(!s)return;const o=e.getAttribute("data-class");o&&s.classList.add(...o.split(" "))}#c=(0,i.s_)(this.#d.bind(this));#d(t){if(t&&!t.some((t=>t.addedNodes.length)))return;let e=!1,s=this.#l.flatMap((t=>[...t.querySelectorAll("slot")]));for(const t of s)t.hasAttribute("name")&&!this.elements.has(t)&&(this.elements.add(t),e=!0);e&&this.#r(this.elements)}}let p=0,m="data-slot-id";class h{#l;slots;constructor(t){this.#l=t,this.slots=new u(t,this.#d.bind(this))}connect(){this.slots.connect(),this.#d();const t=new MutationObserver(this.#c);for(const e of this.#l)t.observe(e,{childList:!0});(0,i.zp)((()=>t.disconnect()))}#c=(0,i.s_)(this.#d.bind(this));#d(){for(const t of this.#l)for(const e of t.children){if(1!==e.nodeType)continue;const t=e.getAttribute("slot");if(!t)continue;e.style.display="none";let s=e.getAttribute(m);s||e.setAttribute(m,s=++p+"");for(const i of this.slots.elements){if(i.getAttribute("name")!==t||i.getAttribute(m)===s)continue;const n=document.importNode(e,!0);t.includes("-icon")&&n.classList.add("vds-icon"),n.style.display="",n.removeAttribute("slot"),this.slots.assign(n,i),i.setAttribute(m,s)}}}}function v({name:t,class:e,state:s,paths:l,viewBox:r="0 0 32 32"}){return n.qy`<svg
    class="${"vds-icon"+(e?` ${e}`:"")}"
    viewBox="${r}"
    fill="none"
    aria-hidden="true"
  ...
  `}function S({tooltip:t}){const{translations:e}=g(),{remotePlaybackState:s}=(0,n.nV)(),o=(0,l.xZ)((()=>`${A(e,"Google Cast")} ${(0,i.Fb)(s())}`)),r=C(e,"Google Cast");return a.qy`
  ...
  `}function Z({tooltip:t}){const{translations:e}=g(),s=C(e,"Play"),i=C(e,"Pause");return a.qy`
  ...
  `}function M({tooltip:t,ref:e=i.lQ}){const{translations:s}=g(),n=C(s,"Mute"),o=C(s,"Unmute");return a.qy`
  ...
  `}function T({tooltip:t}){const{translations:e}=g(),s=C(e,"Closed-Captions On"),i=C(e,"Closed-Captions Off");return a.qy`
  ...
  `}function W({tooltip:t}){const{translations:e}=g(),s=C(e,"Enter Fullscreen"),i=C(e,"Exit Fullscreen");return a.qy`
  ...
  `}function O({backward:t,tooltip:e}){const{translations:s,seekStep:i}=g(),n=t?"Seek Backward":"Seek Forward",o=C(s,n);return a.qy`
  ...
  `}function E(){const{translations:t}=g(),{live:e}=(0,n.nV)(),s=C(t,"Skip To Live"),i=C(t,"LIVE");return e()?a.qy`
        <media-live-button class="vds-live-button" aria-label=${s}>
          <span class="vds-live-button-text">${i}</span>
        </media-live-button>
      `:null}function P(){return(0,l.xZ)((()=>{const{download:t,translations:e}=g(),s=t();if((0,i.gD)(s))return null;const{source:o,title:l}=(0,n.nV)(),r=o(),d=(0,v.d_)({title:l(),src:r,download:s});return(0,i.Kg)(d?.url)?a.qy`
  ...
  `}function it(){return a.qy`
    <media-slider-steps class="vds-slider-steps">
      <template>
        <div class="vds-slider-step"></div>
      </template>
    </media-slider-steps>
  `}function nt({label:t=null,value:e=null,upIcon:s="",downIcon:i="",children:n,isMin:o,isMax:r}){const d=t||e,c=[i?w(i,"down"):null,n,s?w(s,"up"):null];return a.qy`
    <div
  ...
  `}function rt({label:t,option:e,type:s}){const{player:o}=(0,n.$c)(),{translations:r}=g(),d=Q[s],c=()=>A(r,t);function u(){(0,i.io)(),o.dispatchEvent(new Event("vds-font-change"))}if("color"===e.type){let t=function(t){d.set(t.target.value),u()};return tt({label:(0,l.xZ)(c),children:a.qy`
        <input
          ...
          @input=${t}
        />
      `})}if("slider"===e.type){let t=function(t){d.set(t.detail+"%"),u()};const{min:s,max:i,step:n,upIcon:o,downIcon:r}=e;return nt({label:(0,l.xZ)(c),value:(0,l.xZ)(d),upIcon:o,downIcon:r,isMin:()=>d()===s+"%",isMax:()=>d()===i+"%",children:a.qy`
        <media-slider
          class="vds-slider"
          min=${s}
          max=${i}
    ...
    <media-menu class=${`vds-${(0,i.BW)(s)}-menu vds-menu`}>
      ${et({label:c,hint:()=>{const t=d(),e=p.find((e=>e.value===t))?.label||"";return A(r,(0,i.Kg)(e)?e:e())}})}
  ...
  `}function dt({label:t,checked:e,defaultChecked:s=!1,storageKey:n,onChange:o}){const{translations:r}=g(),c=n?localStorage.getItem(n):null,u=(0,i.O)(!!(c??s)),p=(0,i.O)(!1),m=(0,l.xZ)((0,d.M)(u)),h=C(r,t);function v(t){1!==t?.button&&(u.set((t=>!t)),n&&localStorage.setItem(n,u()?"1":""),o(u(),t),p.set(!1))}return n&&o((0,i.se)(u)),e&&(0,i.QZ)((()=>{u.set(e())})),a.qy`
    <div
    ...
    ></div>
  `}function ct(){const{userPrefersAnnouncements:t,translations:e}=g(),s="Announcements";return tt({label:C(e,s),children:dt({label:s,storageKey:"vds-player::announcements",onChange(e){t.set(e)}})})}function ut(){const{translations:t}=g(),e=C(t,"Boost"),s=pt,i=mt,n=ht;return a.qy`
  ...
  `}function ft(){const{remote:t,qualities:e}=(0,n.$c)(),{autoQuality:s,canSetQuality:o,qualities:a}=(0,n.nV)(),{translations:l}=g(),r="Auto";return(0,i.EW)((()=>!o()||a().length<=1))()?null:tt({label:C(l,r),children:dt({label:r,checked:s,onChange(s,i){s?t.requestAutoQuality(i):t.changeQuality(e.selectedIndex,i)}})})}function xt(){const{translations:t}=g(),e=C(t,"Quality");return a.qy`
    <media-quality-slider class="vds-quality-slider vds-slider" aria-label=${e}>
      ${st()}${it()}
    </media-quality-slider>
  `}function At({placement:t,portal:e,tooltip:s}){return(0,l.xZ)((()=>{const{viewType:o}=(0,n.nV)(),{translations:r,menuPortal:c,noModal:u,menuGroup:p,smallWhen:m}=g(),h=(0,i.EW)((()=>u()?(0,i.oA)(t):m()?null:(0,i.oA)(t))),v=(0,i.EW)((()=>m()||"bottom"!==p()||"video"!==o()?0:26)),$=(0,i.O)(!1);!function(){const{player:t}=(0,n.$c)();j.add(t),(0,i.zp)((()=>j.delete(t))),z||((0,i.P1)((()=>{for(const e of(0,i.YD)(Q)){const s=Q[e],n=D[e],o=`--media-user-${(0,i.BW)(e)}`,a=`vds-player:${(0,i.BW)(e)}`;(0,i.QZ)((()=>{const i=s(),l=i===n,r=l?null:X(t,e,i);for(const t of j)t.el?.style.setProperty(o,r);l?localStorage.removeItem(a):localStorage.setItem(a,i)}))}}),null),z=!0)}();const b=a.qy`
      <media-menu-items
      ...
      <media-menu class="vds-playback-menu vds-menu">
        ...
        <media-menu-items class="vds-menu-items">
          ${[J({children:vt()}),(0,l.xZ)((()=>{const{translations:t}=g(),{canSetPlaybackRate:e,playbackRate:s}=(0,n.nV)();return e()?J({label:C(t,"Speed"),value:(0,l.xZ)((()=>1===s()?A(t,"Normal"):s()+"x")),children:[nt({upIcon:"menu-speed-up",downIcon:"menu-speed-down",children:yt(),isMin:()=>s()===$t(),isMax:()=>s()===gt()})]}):null})),(0,l.xZ)((()=>{const{hideQualityBitrate:t,translations:e}=g(),{canSetQuality:s,qualities:o,quality:a}=(0,n.nV)(),r=(0,i.EW)((()=>!s()||o().length<=1)),c=(0,i.EW)((()=>(0,d.F)(o())));return r()?null:J({label:C(e,"Quality"),value:(0,l.xZ)((()=>{const s=a()?.height,i=t()?null:a()?.bitrate,n=i&&i>0?`${(i/1e6).toFixed(2)} Mbps`:null,o=A(e,"Auto");return s?`${s}p${n?` (${n})`:""}`:o})),children:[nt({upIcon:"menu-quality-up",downIcon:"menu-quality-down",children:xt(),isMin:()=>c()[0]===a(),isMax:()=>c().at(-1)===a()}),ft()]})}))]}
        </media-menu-items>
      </media-menu>
    `})),(0,l.xZ)((()=>{const{translations:t}=g();return a.qy`
      <media-menu class="vds-accessibility-menu vds-menu">
        ...
        <media-menu-items class="vds-menu-items">
          ${[J({children:[ct(),(0,l.xZ)((()=>{const{translations:t,userPrefersKeyboardAnimations:e,noKeyboardAnimations:s}=g(),{viewType:o}=(0,n.nV)();if((0,i.EW)((()=>"video"!==o()||s()))())return null;const a="Keyboard Animations";return tt({label:C(t,a),children:dt({label:a,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(t){e.set(t)}})})}))]}),J({children:[(0,l.xZ)((()=>{const{hasCaptions:t}=(0,n.nV)(),{translations:e}=g();return t()?a.qy`
    ...
    `})),(0,l.xZ)((()=>{const{noAudioGain:t,translations:e}=g(),{audioTracks:s,canSetAudioGain:o}=(0,n.nV)();return(0,i.EW)((()=>!(o()&&!t())&&s().length<=1))()?null:a.qy`
      <media-menu class="vds-audio-menu vds-menu">
        ...
        <media-menu-items class="vds-menu-items">
          ${[(0,l.xZ)((()=>{const{translations:t}=g(),{audioTracks:e}=(0,n.nV)(),s=C(t,"Default");return(0,i.EW)((()=>e().length<=1))()?null:J({children:a.qy`
      ...
      `})})),(0,l.xZ)((()=>{const{noAudioGain:t,translations:e}=g(),{canSetAudioGain:s}=(0,n.nV)();if((0,i.EW)((()=>!s()||t()))())return null;const{audioGain:o}=(0,n.nV)();return J({label:C(e,"Boost"),value:(0,l.xZ)((()=>Math.round(100*((o()??1)-1))+"%")),children:[nt({upIcon:"menu-audio-boost-up",downIcon:"menu-audio-boost-down",children:ut(),isMin:()=>100*((o()??1)-1)<=pt(),isMax:()=>100*((o()??1)-1)===mt()})]})}))]}
        </media-menu-items>
      </media-menu>
    ...
    `}))}function _t({orientation:t,tooltip:e}){return(0,l.xZ)((()=>{const{pointer:s,muted:r,canSetVolume:d}=(0,n.nV)();if("coarse"===s()&&!r())return null;if(!d())return M({tooltip:e});const u=(0,i.O)(void 0),p=(0,o._T)(u);return a.qy`
  ...
  `}({orientation:t})}</div>
    ...
    `}))}function wt(){const t=(0,i.O)(void 0),e=(0,i.O)(0),{thumbnails:s,translations:n,sliderChaptersMinWidth:r,disableTimeSlider:d,seekStep:c,noScrubGesture:u}=g(),p=C(n,"Seek"),m=(0,l.xZ)(d),v=(0,l.xZ)((()=>e()<r())),$=(0,l.xZ)(s);return(0,o.wY)(t,(()=>{const s=t();s&&e.set(s.clientWidth)})),a.qy`
    <media-time-slider
  ...
  `}function kt(){return(0,l.xZ)((()=>{const{live:t}=(0,n.nV)();return t()?E():a.qy`
  ...
  `}))}function Ct(){return(0,l.xZ)((()=>{const{textTracks:t}=(0,n.$c)(),{title:e,started:s}=(0,n.nV)(),o=(0,i.O)(null);return(0,r.q)(t,"chapters",o.set),!o()||!s()&&e()?a.qy`<media-title class="vds-chapter-title"></media-title>`:qt()}))}function qt(){return a.qy`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class St extends l.UT{async loadIcons(){const t=(await s.e(6089).then(s.bind(s,6089))).icons,e={};for(const s of Object.keys(t))e[s]=(0,l.In)({name:s,paths:t[s]});return e}}var Zt=s(5466);s(580);let Mt=class extends y{static props={...super.props,when:({viewType:t})=>"audio"===t,smallWhen:({width:t})=>t<576}};function Tt(){const t="top end";return[L({tooltip:"top",placement:t,portal:!0}),At({tooltip:"top end",placement:t,portal:!0})]}class It extends((0,i.xr)(Zt.W,Mt)){static tagName="media-audio-layout";static attrs={smallWhen:{converter:t=>"never"!==t&&!!t}};#v;#y=(0,i.O)(!1);onSetup(){this.forwardKeepAlive=!1,this.#v=(0,n.$c)(),this.classList.add("vds-audio-layout"),this.#f()}onConnect(){x("audio",(()=>this.isMatch)),this.#x()}render(){return(0,l.xZ)(this.#A.bind(this))}#A(){return this.isMatch?[_(),N(),a.qy`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
          ${[O({backward:!0,tooltip:"top start"}),Z({tooltip:"top"}),O({tooltip:"top"}),(0,l.xZ)((()=>{let t=(0,i.O)(void 0),e=(0,i.O)(!1),s=(0,n.$c)(),{title:r,started:d,currentTime:c,ended:u}=(0,n.nV)(),{translations:p}=g(),m=(0,o.ZG)(t),v=()=>d()||c()>0;const $=()=>{const t=u()?"Replay":v()?"Continue":"Play";return`${A(p,t)}: ${r()}`};function b(){return a.qy`
        <span class="vds-title-text">
          ${(0,l.xZ)($)}${(0,l.xZ)((()=>v()?qt():null))}
        </span>
      `}return(0,i.QZ)((()=>{m()&&document.activeElement===document.body&&s.player.el?.focus({preventScroll:!0})})),(0,o.wY)(t,(function(){const s=t(),n=!!s&&!m()&&s.clientWidth<s.children[0].clientWidth;s&&(0,i.p1)(s,"vds-marquee",n),e.set(n)})),r()?a.qy`
          <span class="vds-title" title=${(0,l.xZ)($)} ${h(t.set)}>
            ${[b(),(0,l.xZ)((()=>e()&&!m()?b():null))]}
          </span>
        `:B()})),wt(),(0,l.xZ)((()=>{const{live:t,duration:e}=(0,n.nV)();return t()?E():e()?a.qy`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})),_t({orientation:"vertical",tooltip:"top"}),T({tooltip:"top"}),P(),q({tooltip:"top"}),Tt()]}
        </media-controls-group>
      </media-controls>
    `]:null}#x(){const{menuPortal:t}=g();(0,i.QZ)((()=>{if(!this.isMatch)return;const e=H(this,this.menuContainer,"vds-audio-layout",(()=>this.isSmallLayout)),s=e?[this,e]:[this];return(this.$props.customIcons()?new l.kj(s):new St(s)).connect(),t.set(e),()=>{e.remove(),t.set(null)}}))}#f(){const{pointer:t}=this.#v.$state;(0,i.QZ)((()=>{"coarse"===t()&&(0,i.QZ)(this.#_.bind(this))}))}#_(){this.#y()?((0,i.k6)(this,"pointerdown",(t=>t.stopPropagation())),(0,i.k6)(window,"pointerdown",this.#w.bind(this))):(0,i.k6)(this,"pointerdown",this.#k.bind(this),{capture:!0})}#k(t){const{target:e}=t;(0,o.sb)(e)&&e.closest(".vds-time-slider")&&(t.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),this.#y.set(!0))}#w(){this.#y.set(!1),this.removeAttribute("data-scrubbing")}}var Wt=s(7727);const Ot=(0,p.u$)(class extends p.WL{constructor(){super(...arguments),this.key=a.s6}render(t,e){return this.key=t,e}update(t,[e,s]){return e!==this.key&&((0,Wt.mY)(t),this.key=e),s}});class Et extends y{static props={...super.props,when:({viewType:t})=>"video"===t,smallWhen:({width:t,height:e})=>t<576||e<380}}function Pt(){return(0,l.xZ)((()=>{const t=(0,n.$c)(),{noKeyboardAnimations:e,userPrefersKeyboardAnimations:s}=g();if((0,i.EW)((()=>e()||!s()))())return null;const r=(0,i.O)(!1),{lastKeyboardAction:d}=t.$state;(0,i.QZ)((()=>{r.set(!!d());const t=setTimeout((()=>r.set(!1)),500);return()=>{r.set(!1),window.clearTimeout(t)}}));const c=(0,i.EW)((()=>{const t=d()?.action;return t&&r()?(0,i.BW)(t):null})),u=(0,i.EW)((()=>"vds-kb-action"+(r()?"":" hidden"))),p=(0,i.EW)(Nt),m=(0,i.EW)((()=>{const t=function(){const{$state:t}=(0,n.$c)(),e=t.lastKeyboardAction()?.action;switch(e){case"togglePaused":return t.paused()?"kb-pause-icon":"kb-play-icon";case"toggleMuted":return t.muted()||0===t.volume()?"kb-mute-icon":t.volume()>=.5?"kb-volume-up-icon":"kb-volume-down-icon";case"toggleFullscreen":return`kb-fs-${t.fullscreen()?"enter":"exit"}-icon`;case"togglePictureInPicture":return`kb-pip-${t.pictureInPicture()?"enter":"exit"}-icon`;case"toggleCaptions":return t.hasCaptions()?`kb-cc-${t.textTrack()?"on":"off"}-icon`:null;case"volumeUp":return"kb-volume-up-icon";case"volumeDown":return"kb-volume-down-icon";case"seekForward":return"kb-seek-forward-icon";case"seekBackward":return"kb-seek-backward-icon";default:return null}}();return t?(0,o.TL)(t):null}));return a.qy`
    ...
    `}))}function Nt(){const{$state:t}=(0,n.$c)(),e=t.lastKeyboardAction()?.action,s=t.audioGain()??1;switch(e){case"toggleMuted":return t.muted()?"0%":Bt(t.volume(),s);case"volumeUp":case"volumeDown":return Bt(t.volume(),s);default:return""}}function Bt(t,e){return`${Math.round(t*e*100)}%`}function Vt(){return a.qy`
    <div class="vds-buffering-indicator">
      <media-spinner class="vds-buffering-spinner"></media-spinner>
    </div>
  `}function Ht(){const{menuGroup:t,smallWhen:e}=g(),s=()=>"top"===t()||e()?"bottom":"top",n=(0,i.EW)((()=>`${s()} ${"top"===t()?"end":"center"}`)),o=(0,i.EW)((()=>`${s()} end`));return[L({tooltip:n,placement:o,portal:!0}),At({tooltip:n,placement:o,portal:!0})]}function Lt(){return(0,l.xZ)((()=>{const{noGestures:t}=g();return t()?null:a.qy`
    ...
    `}))}class Gt extends((0,i.xr)(Zt.W,Et)){static tagName="media-video-layout";static attrs={smallWhen:{converter:t=>"never"!==t&&!!t}};#v;onSetup(){this.forwardKeepAlive=!1,this.#v=(0,n.$c)(),this.classList.add("vds-video-layout")}onConnect(){x("video",(()=>this.isMatch)),this.#x()}render(){return(0,l.xZ)(this.#A.bind(this))}#x(){const{menuPortal:t}=g();(0,i.QZ)((()=>{if(!this.isMatch)return;const e=H(this,this.menuContainer,"vds-video-layout",(()=>this.isSmallLayout)),s=e?[this,e]:[this];return(this.$props.customIcons()?new l.kj(s):new St(s)).connect(),t.set(e),()=>{e.remove(),t.set(null)}}))}#A(){const{load:t}=this.#v.$props,{canLoad:e,streamType:s,nativeControls:i}=this.#v.$state;return!i()&&this.isMatch?"play"!==t()||e()?"unknown"===s()?Vt():this.isSmallLayout?[_(),Lt(),Vt(),N(),Pt(),a.qy`<div class="vds-scrim"></div>`,a.qy`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
